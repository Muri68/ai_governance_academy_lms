(function ($) {
    ...
    /*---------------------------------------------------
    Course Review Swiper
    ---------------------------------------------------*/

    var courseReview = null;

    function initCourseReview() {

        if ($('.course-review-active').length) {

            if (courseReview != null) {
                courseReview.destroy(true, true);
            }

            courseReview = new Swiper('.course-review-active .swiper-container', {
                ...
                pagination: {
                    el: '.course-review-active .swiper-pagination',
                    clickable: true,
                },
